...
$('<div class="popup"><div class="popup_keyword1"></div><div class="popup_keyword2"></div><div class="popup_keyword3"></div><div class="popup_keyword4"></div><div class="popup_keyword5"></div></div>').appendTo('body');


//layout of bottom extension
$('<div class="layout"><img class="close-image" src="http://residentialsearch.savills.co.uk/Content/Images/icon_close.png" /><div class="mextension"><div class="keyword1"><p id="keyword1">keyword1</p></div><div class="keyword2"><p id="keyword2">keyword2</p></div><div class="keyword3"><p id="keyword3">keyword3</p></div><div class="keyword4"><p id="keyword4">keyword4</p></div><div class="keyword5"><p id="keyword5"><b>Twitter Tweets</b></p></div><button type="button" id="rifuprevkeyword" style="position: absolute; left: 1224px;top: 5px; background-color: white; width: 43px;height: 26px;">Prev</button><button type="button" id="rifunextkeyword">Next</button></div></div>').appendTo('body');

//change id and class name to starting with rifu_
//popup for each keyword click

//alert("from contescript page");
...
$('#prevkeyword').click(function(){
	//alert("button click");
	chrome.extension.sendRequest({"method":"from_contentscript","button": "prev"});
});
$('#nextkeyword').click(function(){
	//alert("button click");
	chrome.extension.sendRequest({"method":"from_contentscript","button": "next"});
});
$('#tweets').click(function(){
	//alert("button click");
	chrome.extension.sendRequest({"method":"from_contentscript","button": "tweets"});
});
